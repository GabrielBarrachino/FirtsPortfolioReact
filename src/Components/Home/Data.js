...
const Data = () => {
    return (
        <div className="homeData">
            <h1 className="homeTitle">Jhon Smith
                <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <h3 className="homeSubtitle">Virtual Designer</h3>
            <p className="homeDescription">I'm creative designer based in New York, and I'm very passionate and dedicated to my work.</p>
