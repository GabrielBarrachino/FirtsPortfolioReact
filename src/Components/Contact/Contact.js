                ...
                <div className="contactContent">
                    ...
                    <div className="contactInfo">
                        <div className="contactCard">
                            ...
                            <span className="contactCardData">user@gmail.com</span>

                            <a href="#" className="contactButton" target="_blank">
                                <span>Write me</span>
                        ...
                        <div className="contactCard">
                            ...
                            <span className="contactCardData">999-888-777</span>
                        ...
                        <div className="contactCard">
                            ...
                            <span className="contactCardData">user.1234</span>
                ...
                <div className="contactContent">
                    ...
                    <form action="" className="contactForm">
                        <div className="contactFormDiv">
                            ...
                            <input className="contactFormInput" type="text" name="name" placeholder="Ex: Mike" />
                        </div>

                        <div className="contactFormDiv">
                            <label className="contactFormTag">Email</label>
                            <input className="contactFormInput" type="email" name="email" placeholder="exemple@gmail.com" />
                        </div>

                        <div className="contactFormDiv contactFormArea">
                            <label className="contactFormTag">Project</label>
                            <textarea name="project" cols='30' rows='10' className="contactFormInput contactFormArea" placeholder="Write your project idea"/>
                        </div>
